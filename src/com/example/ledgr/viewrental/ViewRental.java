...
import com.example.ledgr.viewitem.ViewItemPictureFragment;
import com.viewpagerindicator.TitlePageIndicator;

public class ViewRental extends FragmentActivity {
    ...
    private class ScreenSlidePagerAdapter extends FragmentPagerAdapter  {
        ...
        protected final String[] CONTENT = new String[] { "Rental Info", "Item Info", "Pictures" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getActionBar().setTitle("");
			...
			fragments[0] = new ViewRentalFragment();
			fragments[0].setArguments(bundle);
			fragments[1] = new ViewItemFragment();
			fragments[1].setArguments(bundle);
			fragments[2] = new ViewItemPictureFragment();
